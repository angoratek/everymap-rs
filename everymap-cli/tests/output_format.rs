...
#[test]
fn test_geofence_search_help() {
    cli()
        .args(["geofence-search", "--help"])
        .assert()
        .success()
        .stdout(predicate::str::contains("--lat"))
...
#[test]
fn test_geofence_create_help() {
    cli()
        .args(["geofence-create", "--help"])
        .assert()
        .success()
        .stdout(predicate::str::contains("--radius"))
...
#[test]
fn test_geofence_get_help() {
    cli()
        .args(["geofence-get", "--help"])
        .assert()
        .success()
...
#[test]
fn test_geofence_delete_help() {
    cli()
        .args(["geofence-delete", "--help"])
        .assert()
        .success()
        .stdout(predicate::str::contains("<ID>"));
}
...
#[test]
fn test_trip_create_help() {
    cli()
        .args(["trip-create", "--help"])
        .assert()
        .success()
        .stdout(predicate::str::contains("--origin"))
        .stdout(predicate::str::contains("--destination"))
...
#[test]
fn test_trip_update_help() {
    cli()
        .args(["trip-update", "--help"])
        .assert()
        .success()
        .stdout(predicate::str::contains("--trip-id"))
        .stdout(predicate::str::contains("--status"));
}

#[test]
fn test_trip_get_help() {
    cli()
        .args(["trip-get", "--help"])
        .assert()
        .success()
...
#[test]
fn test_fraud_check_help() {
    cli()
        .args(["fraud-check", "--help"])
        .assert()
        .success()
