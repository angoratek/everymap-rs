...
impl GoogleClient {
    ...
    pub fn new(auth_provider: Arc<dyn AuthProvider>) -> Self {
        Self {
            inner: everymap_core::client::ProviderClient::new(auth_provider, "google"),
        }
    }
    ...
    pub fn with_client_builder(
        ...
        Ok(Self {
            inner: everymap_core::client::ProviderClient::with_client_builder(builder, auth_provider, "google")?,
        })
    }
