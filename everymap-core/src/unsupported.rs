...
macro_rules! unsupported_isoline {
    ($struct_name:ident, $provider:expr) => {
        ...
        impl everymap_core::domains::isoline::IsolineProvider for $struct_name {
            ...
            ) -> everymap_core::error::EveryMapResult<everymap_core::domains::isoline::IsolineResponse> {
                Err(everymap_core::error::EveryMapError::unsupported_domain($provider, "isoline"))
            }
        }
    };
}
...
macro_rules! unsupported_traffic {
    ($struct_name:ident, $provider:expr) => {
        ...
        impl everymap_core::domains::traffic::TrafficProvider for $struct_name {
            ...
            ) -> everymap_core::error::EveryMapResult<everymap_core::domains::traffic::TrafficResponse> {
                Err(everymap_core::error::EveryMapError::unsupported_domain($provider, "traffic"))
            }
        }
    };
}
    ...
    ($struct_name:ident, $provider:expr) => {
        ...
        impl everymap_core::domains::tour::TourPlanner for $struct_name {
            async fn optimize_tour(
                ...
                Err(everymap_core::error::EveryMapError::unsupported_domain($provider, "tour"))
            }
        }
    };
}
    ...
    ($struct_name:ident, $provider:expr) => {
        ...
        impl everymap_core::domains::tiling::TileProvider for $struct_name {
            async fn get_tile(
                ...
                Err(everymap_core::error::EveryMapError::unsupported_domain($provider, "tiling"))
            }
        }
    };
}
...
macro_rules! unsupported_positioner {
    ($struct_name:ident, $provider:expr) => {
        ...
        impl everymap_core::domains::positioning::NetworkPositioner for $struct_name {
            ...
            ) -> everymap_core::error::EveryMapResult<everymap_core::domains::positioning::PositioningResponse> {
                Err(everymap_core::error::EveryMapError::unsupported_domain($provider, "positioning"))
            }
        }
    };
}
...
macro_rules! unsupported_attributes {
    ($struct_name:ident, $provider:expr) => {
        ...
        impl everymap_core::domains::attributes::AttributeProvider for $struct_name {
            ...
            ) -> everymap_core::error::EveryMapResult<everymap_core::domains::attributes::AttributeResponse> {
                Err(everymap_core::error::EveryMapError::unsupported_domain($provider, "attributes"))
            }
        }
    };
}
...
macro_rules! unsupported_geofence {
    ($struct_name:ident, $provider:expr) => {
        ...
        impl everymap_core::domains::geofencing::GeofenceProvider for $struct_name {
            ...
            ) -> everymap_core::error::EveryMapResult<everymap_core::domains::geofencing::GeofenceResponse> {
                Err(everymap_core::error::EveryMapError::unsupported_domain($provider, "geofencing"))
            }

            async fn create_geofence(
                &self,
                _options: &everymap_core::domains::geofencing::GeofenceCreateOptions,
            ) -> everymap_core::error::EveryMapResult<everymap_core::domains::geofencing::GeofenceResult> {
                Err(everymap_core::error::EveryMapError::unsupported_domain($provider, "geofencing"))
            }
    ...
    ($struct_name:ident, $provider:expr) => {
        ...
        impl everymap_core::domains::tracking::TripTracker for $struct_name {
            async fn create_trip(
                ...
                Err(everymap_core::error::EveryMapError::unsupported_domain($provider, "tracking"))
            }
    ...
    ($struct_name:ident, $provider:expr) => {
        ...
        impl everymap_core::domains::fraud::FraudDetector for $struct_name {
            async fn check_fraud(
                ...
                Err(everymap_core::error::EveryMapError::unsupported_domain($provider, "fraud"))
            }
        }
    };
}